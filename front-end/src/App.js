...
// //               </ProtectedRoute>
// //               }/>
// //             <Route path = "/dashboardBanker" element={
...
// //             {/* <Route path="/loanApplications" element={<LoanApplicationList />} />
// //         <Route path="/loanApplications/:id" element={<LoanApplicationEdit />} />
// //         <Route path="/loanApplications/new" element={<LoanApplicationEdit />} /> */}
...
//                 <Route path="/dashboardBanker" element={<ProtectedRoute allowedRoles={["BANKER"]}><DashboardBanker /></ProtectedRoute>} />
//                 <Route path="/myApplications" element={<ProtectedRoute allowedRoles={["CLIENT"]}><LoanApplicationList/></ProtectedRoute>} />
//                 <Route path="/loanApplications/:id" element={<ProtectedRoute allowedRoles={["CLIENT"]}><LoanApplicationEdit /></ProtectedRoute>} />
//                 <Route path="/loanApplications/new" element={<ProtectedRoute allowedRoles={["CLIENT"]}><LoanApplicationEdit /></ProtectedRoute>} />
//             </Routes>
//         </Router>
//     );
// }
